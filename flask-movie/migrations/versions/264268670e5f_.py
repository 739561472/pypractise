...
Revision ID: 264268670e5f
Revises: 
Create Date: 2018-02-11 20:50:42.737018
...
def upgrade():
    ...
    sa.Column('facepic', sa.String(length=255), nullable=False),
    sa.Column('addtime', sa.DateTime(), nullable=True),
    sa.Column('uuid', sa.String(length=255), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('email'),
    sa.UniqueConstraint('facepic'),
    sa.UniqueConstraint('password'),
    sa.UniqueConstraint('phonenumber'),
    sa.UniqueConstraint('username'),
    sa.UniqueConstraint('uuid')
    )
    op.create_index(op.f('ix_user_addtime'), 'user', ['addtime'], unique=True)
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('commentnum'),
    sa.UniqueConstraint('logo'),
    sa.UniqueConstraint('title'),
    sa.UniqueConstraint('url')
    )
